...
public class UserAuthenticationServiceImpl implements UserAuthenticationService {
	...
	private final UserAutheticationRepository userAutheticationRepository;
	...
	public boolean saveUser(User user) throws UserAlreadyExistsException {
		try {
			Optional<User> userExist = Optional.ofNullable(this.userAutheticationRepository.findById(user.getUserId()))
					.get();
